    ...
    <h1 class="text-2xl font-sans text-gray-800 mb-6">Articles admin</h1>        
        <div class="font-sans">
            ...
            <div class="flex justify-between items-center mb-6">
                ...
                class="bg-black text-white text-xs font-bold px-4 py-2 uppercase tracking-wide inline-block">
                    + Nouvel article
                </a>
            </div>
                        ...
                        @foreach($articles as $article)
                            <tr class="hover:bg-gray-50">
                                ...
                                <td class="p-3 text-right text-base whitespace-nowrap space-x-3">
                                    ...
                                    @else
                                        <button title="Déjà publié" disabled class="cursor-not-allowed">
                                            <i data-lucide="send" class="w-5 h-5 text-gray-300"></i>
                                        </button>
                                    @endif
                                </td>
                            </tr>
